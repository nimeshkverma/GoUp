...
class LoanPurposeList(mixins.ListModelMixin,
                      mixins.CreateModelMixin,
                      generics.GenericAPIView):
    queryset = models.LoanPurpose.active_objects.all()
    serializer_class = serializers.LoanPurposeSerializer
...
class LoanPurposeDetail(mixins.RetrieveModelMixin,
                        mixins.UpdateModelMixin,
                        mixins.DestroyModelMixin,
                        generics.GenericAPIView):
    queryset = models.LoanPurpose.objects.all()
    serializer_class = serializers.LoanPurposeSerializer
