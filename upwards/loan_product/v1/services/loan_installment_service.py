    ...
    def __set_emi_data(self):
        ...
        for installment_object in installment_objects:
            ...
            installment_data = {
                ...
                'penalty': self.__penalty(installment_object) if not installment_object.installment_paid else 0
            }
    ...
    def get_repayment_data(self):
        ...
        for installment_object in installment_objects:
            ...
            late_payment_penalty = late_payment_penalty + \
                self.__penalty(
                    installment_object) if not installment_object.installment_paid else late_payment_penalty
