...
from homepage_config import (ELIGIBILITY_TITLE, KYC_TITLE, LOAN_CONSTANTS, LOAN_PRODUCT_STATES,
                             USER_STATES_WITHOUT_ELIGIBILITY_AMOUNT, USER_STATES_WITH_ELIGIBILITY_AMOUNT,
                             USER_STATE_MESSAGES, BORROWER_STATES)
...
class Homepage(object):
    ...
    def __get_data(self):
        ...
        if self.present_state in USER_STATES_WITHOUT_ELIGIBILITY_AMOUNT:
            return self.__pre_eligibility_amount_homepage_data()
        return {}
    ...
    def __get_loan_product_homepage_data(self, loan_variable=None):
        ...
        homepage_data = {
            ...
            'loan_variable': loan_variable if loan_variable else {},
        }
