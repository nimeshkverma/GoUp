...
urlpatterns = [
    url(r'^third_party_leads/(?P<user_name>[\w\-]+)/borrower/$',
        views.ThirdPartyLeadList.as_view()),
    url(r'^third_party_leads/(?P<user_name>[\w\-]+)/borrower/(?P<pk>[0-9]+)/$',
        views.ThirdPartyLeadDetail.as_view()),
    url(r'^third_party_leads/(?P<user_name>[\w\-]+)/borrower/document/$',
        views.ThirdPartyLeadDocumentsCreate.as_view(), name='ThirdPartyLeadDocumentsCreate'),
    url(r'^third_party_leads/(?P<user_name>[\w\-]+)/borrower/(?P<pk>[0-9]+)/document/$',
